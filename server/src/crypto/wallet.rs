...
use crate::crypto::id::Auth;
use crate::crypto::tx::IssueTx;
use crate::crypto::tx::{SealedIssueTx, SealedSplitTx, SplitTx};
use crate::crypto::Error;
use crate::crypto::{asset::Asset, id::Address, note::Blind};
use crate::crypto::{
...
pub trait CommReceiver<E: SNARK> {
    fn receive(&mut self, history: &NoteHistory<E>) -> Result<(), Error>;
...
impl<E: SNARK> CommReceiver<E> for Wallet<E> {
    fn receive(&mut self, note_history: &NoteHistory<E>) -> Result<(), Error> {
